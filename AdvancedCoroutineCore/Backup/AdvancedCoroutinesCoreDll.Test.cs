...
namespace AdvancedCoroutines.Test
{
    ...
    public class AdvancedCoroutinesCoreDllTest
    {
        ...
        [Test]
        public void AdvancedCoroutinesCoreDll_StartCoroutineWithYieldBreak()
        {
            var _dll = new Core.AdvancedCoroutinesCoreDll(null);
            var routine = _dll.StartCoroutine(enumerator_break(), this);
        ...
        private IEnumerator enumerator_break()
        {
            yield break;
        }
    }
